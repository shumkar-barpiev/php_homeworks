...
<div class="container mt-3">
    <div class="main-body">
		...
		<section class="d-flex justify-content-between bg-dark p-5" ></section>
		<?php
			if(isset($_COOKIE['fullname']) && isset($_COOKIE['gender']) && isset($_COOKIE['softwareEngineer']) && isset($_COOKIE['jobTitle']) && isset($_COOKIE['email']) && isset ($_COOKIE['phonenumber']) && isset ($_COOKIE['address'])){
		 ?>
				<h1><?php echo $_COOKIE["fullname"];?></h1>
				<h1><?php echo $_COOKIE["gender"];?></h1>
				<h1><?php echo $_COOKIE["softwareEngineer"];?></h1>
				<h1><?php echo $_COOKIE["jobTitle"];?></h1>
				<h1><?php echo $_COOKIE["skills"];?></h1>
				<h1><?php echo $_COOKIE["email"];?></h1>
				<h1><?php echo $_COOKIE["phonenumber"];?></h1>
				<h1><?php echo $_COOKIE["address"];?></h1>
	<?php } else{ ?>
				<h1>Cookies are empty!!!</h1>
	<?php } ?>
<?php
		$this->importFoot();
	}
